...
def main():
    ...
    if success:
        ...
        print("\n[ 다음 단계 ]")
        print("1. 기존 smol_koreantalk_data.jsonl 백업:")
        print(f"   mv /home/work/tesseract/korean_large_data/cleaned_jsonl/smol_koreantalk_data.jsonl \\")
        print(f"      /home/work/tesseract/korean_large_data/cleaned_jsonl/smol_koreantalk_data.jsonl.bak")
        print("\n2. 새 파일을 원래 이름으로 변경:")
        print(f"   mv {output_path} \\")
        print(f"      /home/work/tesseract/korean_large_data/cleaned_jsonl/smol_koreantalk_data.jsonl")
        print("\n3. 학습 스크립트 실행:")
        print(f"   python /home/work/tesseract/qwen/2.5_14B_Inst/0_qwen14b_multiturn_ft.py")
    else:
        print("\n[ ERROR ] 다운로드 실패")
